...
### Фаза 10: Документация и примеры ✅ ЗАВЕРШЕНО

- [x] 13. Обновление документации
  - [x] 13.1 Обновить документацию
    - Обновлен `docs/DSL_SYNTAX.md` - добавлен раздел 7 о permissions
    - Обновлен `docs/SECURITY.md` - добавлен раздел 6 о StepPermissions
    - Обновлен `docs/CUSTOM_ADAPTERS.md` - добавлены методы для permissions и file output
    - Добавлена таблица маппинга permissions на флаги CLI
    - _Requirements: 7.1_

  - [x] 13.2 Обновить существующие примеры workflow с использованием permissions
    - Обновлен `examples/business-requirements-workflow.yaml`
    - Добавлены default_permissions для ролей architect и copilot
    - Добавлены явные permissions для step10_final_requirements
    - _Requirements: 7.1_

  - [~] 13.3 Миграционное руководство (отложено)
    - Релиза проекта ещё не было, миграция не требуется
    - Документация актуальна для новых пользователей
