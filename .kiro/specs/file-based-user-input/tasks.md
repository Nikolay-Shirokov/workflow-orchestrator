...
- [-] 6. Реализация FileInputHandler
  ...
  - [ ] 6.2 Реализовать метод createTemplateFile()
  ...
  - [ ] 6.3 Реализовать метод openInEditor()
  ...
  - [ ] 6.4 Реализовать метод waitForUserConfirmation()
  ...
  - [ ] 6.5 Реализовать метод readAndValidate()
  ...
  - [ ] 6.6 Написать unit tests для FileInputHandler
  ...
  - [ ] 6.7 Написать property test для приостановки процесса
  ...
  - [ ] 6.8 Написать property test для интерактивного меню
  ...
  - [ ] 6.9 Написать property test для валидации
