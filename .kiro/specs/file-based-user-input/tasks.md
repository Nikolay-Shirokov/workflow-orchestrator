...
- [ ] 8. Интеграция с StepExecutor
  - [ ] 8.1 Модифицировать executeUserInputStep() в step-executor.ts
  ...
  - [ ] 8.2 Добавить обработку возобновления процесса
  ...
  - [ ] 8.3 Добавить сохранение данных в контекст
