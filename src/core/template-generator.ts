...
export class TemplateGenerator {
  ...
  private generateMarkdownTemplate(
    ...
    lines.push('');
    lines.push('Пожалуйста, заполните этот файл и сохраните его.');
    lines.push('После заполнения вернитесь в терминал и введите команду "продолжить" или "готово".');
    lines.push('');
    
    // Сообщение с промптом
    ...
    if (questions.length > 0) {
      ...
      // Если вопросов нет, добавляем секцию для свободного ответа
      lines.push('## Ваш ответ');
      lines.push('');
      lines.push('<!-- Напишите ваш ответ здесь -->');
      lines.push('');
  ...
  private generateTextTemplate(
    ...
    lines.push('ИНСТРУКЦИИ:');
    lines.push('-'.repeat(70));
    lines.push('1. Заполните этот файл');
    lines.push('2. Сохраните файл');
    lines.push('3. Вернитесь в терминал и введите "продолжить" или "готово"');
    lines.push('');
